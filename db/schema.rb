...
ActiveRecord::Schema.define(version: 20160309203023) do

  create_table "accounts", force: :cascade do |t|
    t.string   "supplier_id", limit: 255
    t.string   "acc_no",      limit: 255
    t.string   "acc_balance", limit: 255
  ...
  create_table "names", force: :cascade do |t|
    ...
    t.string   "appointments", limit: 255
    t.text     "address",      limit: 65535
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string   "order_price",    limit: 255
    t.string   "order_quantity", limit: 255
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
  end
