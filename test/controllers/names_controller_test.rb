...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { address: @name.address, appointments: @name.appointments, phone_no: @name.phone_no, speciality: @name.speciality }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { address: @name.address, appointments: @name.appointments, phone_no: @name.phone_no, speciality: @name.speciality }
    assert_redirected_to name_path(assigns(:name))
  end
