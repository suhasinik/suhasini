...
class PhysiciansControllerTest < ActionController::TestCase
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post :create, physician: { address: @physician.address, name: @physician.name, phone: @physician.phone, speciality: @physician.speciality }
    end
  ...
  test "should update physician" do
    patch :update, id: @physician, physician: { address: @physician.address, name: @physician.name, phone: @physician.phone, speciality: @physician.speciality }
    assert_redirected_to physician_path(assigns(:physician))
  end
